...
//  AttendanceSystem
//
//  Created by Mohsin on 03/01/2015.
//  Copyright (c) 2015 PanaCloud. All rights reserved.
//

import UIKit

class SubTeams1VC: UIViewController, UISplitViewControllerDelegate {
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if indexPath.row < self.team.subTeams.count {
            //            let tempVC1 = self.storyboard?.instantiateViewControllerWithIdentifier("subTeamsID") as SubTeamsVC
            ...
            performSegueWithIdentifier("subTeam1Seg", sender: indexPath)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "subTeam1Seg"{
            
            let desVC = segue.destinationViewController as SubTeams1VC
